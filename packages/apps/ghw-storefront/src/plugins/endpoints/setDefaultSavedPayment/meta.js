export default {
  name: 'setDefaultSavedPayment',
  description: 'Description for setDefaultSavedPayment',
  author: 'ThanxMedia',
  ...
  input: 'braintree-widgets/src/plugins/endpoints/setDefaultSavedPayment/schema/input.json',
  ...
  output: 'braintree-widgets/src/plugins/endpoints/setDefaultSavedPayment/schema/output.json',
  packageId: ''
};
