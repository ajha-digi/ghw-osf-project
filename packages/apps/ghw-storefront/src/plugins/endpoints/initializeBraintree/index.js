...
const url = '/ccstorex/custom/v1/bt-client-token';
...
const initializeBraintree = {
  ...
  async getRequest() {
    const requestPayloadData = {
      method: 'POST',
      body: {siteId: 'siteUS'},
      headers: {'x-braintree-site-id': 'siteUS', 'Content-Type': 'application/x-www-form-urlencoded'}
    };
...
export default initializeBraintree;
