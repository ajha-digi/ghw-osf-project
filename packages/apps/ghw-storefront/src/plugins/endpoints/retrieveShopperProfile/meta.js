export default {
  name: 'retrieveShopperProfile',
  description: 'Description for retrieveShopperProfile',
  author: 'ThanxMedia',
  ...
  input: 'braintree-widgets/src/plugins/endpoints/retrieveShopperProfile/schema/input.json',
  ...
  output: 'braintree-widgets/src/plugins/endpoints/retrieveShopperProfile/schema/output.json',
  packageId: ''
};
