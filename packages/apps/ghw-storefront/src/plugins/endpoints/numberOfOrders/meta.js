export default {
  ...
  input: 'ghw-storefront/src/plugins/endpoints/numberOfOrders/schema/input.json',
  ...
  output: 'ghw-storefront/src/plugins/endpoints/numberOfOrders/schema/output.json',
  packageId: ''
};
