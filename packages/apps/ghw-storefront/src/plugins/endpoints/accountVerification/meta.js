export default {
  ...
  input: '@oracle-cx-commerce/core-commerce-reference-store-storefront-prov/src/plugins/endpoints/accountVerification/schema/input.json',
  ...
  output: '@oracle-cx-commerce/core-commerce-reference-store-storefront-prov/src/plugins/endpoints/accountVerification/schema/output.json',
  packageId: ''
};
