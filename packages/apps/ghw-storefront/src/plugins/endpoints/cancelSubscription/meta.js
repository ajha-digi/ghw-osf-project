export default {
  ...
  description: 'Description for cancelSubscription',
  author: 'roycalvo',
  ...
  input: 'braintree-widgets/src/plugins/endpoints/cancelSubscription/schema/input.json',
  ...
  output: 'braintree-widgets/src/plugins/endpoints/cancelSubscription/schema/output.json',
  packageId: ''
};
