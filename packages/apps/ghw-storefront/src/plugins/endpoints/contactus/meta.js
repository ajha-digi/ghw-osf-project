export default {
  ...
  input: '@oracle-cx-commerce/core-commerce-reference-store-storefront-prov/src/plugins/endpoints/contactus/schema/input.json',
  ...
  output: '@oracle-cx-commerce/core-commerce-reference-store-storefront-prov/src/plugins/endpoints/contactus/schema/output.json',
  packageId: ''
};
