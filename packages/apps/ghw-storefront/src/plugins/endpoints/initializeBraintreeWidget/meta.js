export default {
  name: 'initializeBraintreeWidget',
  description: 'Description for initializeBraintreeWidget',
  author: 'roycalvo',
  ...
  input: 'braintree-widgets/src/plugins/endpoints/initializeBraintreeWidget/schema/input.json',
  ...
  output: 'braintree-widgets/src/plugins/endpoints/initializeBraintreeWidget/schema/output.json',
  packageId: ''
};
