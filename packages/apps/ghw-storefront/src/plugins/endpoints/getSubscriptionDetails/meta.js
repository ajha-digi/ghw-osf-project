export default {
  ...
  description: 'Description for getSubscriptionDetails',
  ...
  input:
    '@oracle-cx-commerce/core-commerce-reference-store-storefront-prov/src/plugins/endpoints/getSubscriptionDetails/schema/input.json',
  ...
  output:
    '@oracle-cx-commerce/core-commerce-reference-store-storefront-prov/src/plugins/endpoints/getSubscriptionDetails/schema/output.json',
  packageId: ''
};
