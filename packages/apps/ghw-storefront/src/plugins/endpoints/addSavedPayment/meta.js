export default {
  name: 'addSavedPayment',
  description: 'Description for addSavedPayment',
  author: 'ThanxMedia',
  ...
  input: 'braintree-widgets/src/plugins/endpoints/addSavedPayment/schema/input.json',
  ...
  output: 'braintree-widgets/src/plugins/endpoints/addSavedPayment/schema/output.json',
  packageId: ''
};
