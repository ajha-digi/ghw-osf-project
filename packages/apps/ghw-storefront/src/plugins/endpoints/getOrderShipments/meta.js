export default {
  ...
  description: 'Description for getOrderShipments',
  ...
  input: '@oracle-cx-commerce/core-commerce-reference-store-storefront-prov/src/plugins/endpoints/getOrderShipments/schema/input.json',
  ...
  output: '@oracle-cx-commerce/core-commerce-reference-store-storefront-prov/src/plugins/endpoints/getOrderShipments/schema/output.json',
  packageId: ''
};
