export default {
  ...
  input: 'ghw-storefront/src/plugins/endpoints/signifydCheckout/schema/input.json',
  ...
  output: 'ghw-storefront/src/plugins/endpoints/signifydCheckout/schema/output.json',
  packageId: ''
};
