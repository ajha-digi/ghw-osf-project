export default {
  name: 'deleteSavedPayment',
  description: 'Description for deleteSavedPayment',
  author: 'ThanxMedia',
  ...
  input: 'braintree-widgets/src/plugins/endpoints/deleteSavedPayment/schema/input.json',
  ...
  output: 'braintree-widgets/src/plugins/endpoints/deleteSavedPayment/schema/output.json',
  packageId: ''
};
