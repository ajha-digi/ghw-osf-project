export default {
  name: 'getOrders',
  description: 'Description for getOrders',
  ...
  input: '@oracle-cx-commerce/core-commerce-reference-store-storefront-prov/src/plugins/endpoints/getOrders/schema/input.json',
  ...
  output: '@oracle-cx-commerce/core-commerce-reference-store-storefront-prov/src/plugins/endpoints/getOrders/schema/output.json',
  packageId: ''
};
