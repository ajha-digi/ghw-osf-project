...
export const GHWProductTest = () => import('../index');

describe('GHWProductTest renders correctly and shows after changing visible state', () => {
  /**
   * Reference to dynamic imported comps to resolve and preload.
   */
  const comps = {GHWProductTest};
  beforeAll(async () => {
    /**
  ...
  it('GHWProductTest works as expected', async done => {
    /**
