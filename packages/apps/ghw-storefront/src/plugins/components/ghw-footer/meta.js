...
const widgetResourceKeys = ['faqTitle','faqLink', 'rewardsTitle', 'rewardsLink', 'customerServiceTitle', 'customerServiceLink', 'cancellationTitle', 'cancellationLink', 'guaranteeTitle', 'guaranteeLink', 'returnPolicyTitle', 'returnPolicyLink', 'privacyPolicyLink', 'tcLink', 'retunPolicyLink', 'copyrightNoticeLink'];
/**
...
export default {
  name: 'GHWFooter',
  decription: 'Description of widget GHWFooter',
  author: 'AC',
  fetchers: [],
  actions: [],
  /**
