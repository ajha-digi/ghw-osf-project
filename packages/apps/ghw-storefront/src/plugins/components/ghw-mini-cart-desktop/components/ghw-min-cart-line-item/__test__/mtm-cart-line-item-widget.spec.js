...
export const GHWCartLineItem = () => import('../index');

describe('GHWCartLineItem renders correctly and shows after changing visible state', () => {
  /**
   * Reference to dynamic imported comps to resolve and preload.
   */
  const comps = {GHWCartLineItem};
  beforeAll(async () => {
    /**
  ...
  it('GHWCartLineItem works as expected', async done => {
    /**
