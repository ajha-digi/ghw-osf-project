...
export const GHWDropdown = () => import('../index');

describe('GHWDropdown renders correctly and shows after changing visible state', () => {
  /**
   * Reference to dynamic imported comps to resolve and preload.
   */
  const comps = {GHWDropdown};
  beforeAll(async () => {
    /**
  ...
  it('GHWDropdown works as expected', async done => {
    /**
