...
export const GHWCartItemTable = () => import('../index');

describe('GHWCartItemTable renders correctly and shows after changing visible state', () => {
  /**
   * Reference to dynamic imported comps to resolve and preload.
   */
  const comps = {GHWCartItemTable};
  beforeAll(async () => {
    /**
  ...
  it('GHWCartItemTable works as expected', async done => {
    /**
