...
export const GHWCartItemRow = () => import('../index');

describe('GHWCartItemRow renders correctly and shows after changing visible state', () => {
  /**
   * Reference to dynamic imported comps to resolve and preload.
   */
  const comps = {GHWCartItemRow};
  beforeAll(async () => {
    /**
  ...
  it('GHWCartItemRow works as expected', async done => {
    /**
