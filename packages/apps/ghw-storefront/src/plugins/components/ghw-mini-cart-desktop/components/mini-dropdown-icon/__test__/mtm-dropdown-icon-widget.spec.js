...
export const GHWDropdownIcon = () => import('../index');

describe('GHWDropdownIcon renders correctly and shows after changing visible state', () => {
  /**
   * Reference to dynamic imported comps to resolve and preload.
   */
  const comps = {GHWDropdownIcon};
  beforeAll(async () => {
    /**
  ...
  it('GHWDropdownIcon works as expected', async done => {
    /**
