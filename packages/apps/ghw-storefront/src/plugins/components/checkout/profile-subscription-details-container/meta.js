 ...
 */
export default {
  name: 'ProfileSubscriptionDetailsContainer',
  decription: 'Description of widget ProfileSubscriptionDetailsContainer',
  type: 'container',
  fetchers: [],
  /**
  ...
  pageTypes: ['profile'],
  providesContext: ['order_context', 'product_selection_context'],
  actions: ['getOrder', 'notify']
};
