...
export const achdirectdebit = () => import('../index');

describe('achdirectdebit renders correctly and shows after changing visible state', () => {
  /**
   * Reference to dynamic imported comps to resolve and preload.
   */
  const comps = {achdirectdebit};
  beforeAll(async () => {
    /**
  ...
  it('achdirectdebit works as expected', async done => {
    /**
