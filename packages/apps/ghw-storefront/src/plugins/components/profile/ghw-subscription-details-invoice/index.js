...
const GHWSubscriptionsDetailsInvoice = props => {
  ...
  return (
    <Styled id="GHWSubscriptionsDetailsInvoice" css={css}>
...
export default connect(getPageData)(GHWSubscriptionsDetailsInvoice);
