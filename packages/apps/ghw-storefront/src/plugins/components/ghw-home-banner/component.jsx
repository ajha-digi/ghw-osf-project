 ...
 */
 ...
 import css from "./ghw-home-banner.css";
 ...
 const GHWHomeBanner = (props) => {
   ...
   return (
     <Styled id="GHWHomeBanner" css={css}>
       {slides.length > 0 && (
         <div className="GHWHomeBanner">
           <GenericCarousel
             slides={slides}
