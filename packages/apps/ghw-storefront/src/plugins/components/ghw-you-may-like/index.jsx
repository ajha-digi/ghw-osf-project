...
const GHWYouMayLike = (props) => {
  const { isAutoSlide = false, autoSlideInterval = 15000, title } = props;
  ...
  return (
    <Styled id="GHWYouMayLike" css={css}>
      {slides.length > 0 && (
        <div className="GHWYouMayLike">
